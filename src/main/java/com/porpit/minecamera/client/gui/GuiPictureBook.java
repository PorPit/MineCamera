...
public class GuiPictureBook extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRendererObj.drawString(I18n.format("container.picture_book.text.inputinfo"), 170, 10, 0x8B4513);
		this.fontRendererObj.drawString(
				I18n.format("container.picture_book.text.pictureindex") + " " + (inventory.getIndex() + 1), 70, 124,
				0x8B4513);
		this.fontRendererObj.drawString(
				I18n.format("container.picture_book.text.totalpicturenum") + " " + inventory.getTotalPictureNum(), 160,
				124, 0x8B4513);
		...
		if (this.inventory.getSlot(1).getHasStack()) {
			...
			if (itemStackPicture.hasTagCompound() && itemStackPicture.getTagCompound().hasKey("pid")) {
				...
				if (!imagename.equals("") && imagename.contains("%_%")) {
					...
					this.fontRendererObj.drawString(I18n.format("container.picture_book.text.owner") + author, 55, 10,
							0x8B4513);
					this.fontRendererObj.drawString(I18n.format("container.picture_book.text.time") + d, 85, 115,
							0x8B4513);
				} else {
					this.fontRendererObj.drawString(I18n.format("container.picture_book.text.error"), 55, 10, 0x8B4513);
				}
			} else {
				this.fontRendererObj.drawString(I18n.format("container.picture_book.text.null"), 55, 10, 0x8B4513);
			}
		}
