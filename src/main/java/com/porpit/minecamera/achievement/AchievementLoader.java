...
public class AchievementLoader {
	...
	public static Achievement craftpictureframe_multiple = new Achievement("achievement.minecamera.craftpictureframe_multiple",
            "minecamera.craftpictureframe_multiple", -4, -2, BlockLoader.pictureFrameMultiple,craftpictureframe);
	...
	public static AchievementPage pageMineCamera = new AchievementPage(MineCamera.NAME,craftcamera,craftprocessor,crafttripod,craftglasses,craftpictureframe,craftpictureframe_multiple,craftfilm,craftphoto_paper);
